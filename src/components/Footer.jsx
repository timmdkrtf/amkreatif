            ...
            <div className="container">
                <div className="row justify-content-between">
                    <div className="col-lg-5 col-md-6 col-12">
                        <h2>PT Abdi Media Kreatif</h2>
                        <ul style={{listStyleType:"none", padding:"0"}}>
                            <li className="">
                                <a href="https://maps.app.goo.gl/TNEkr7f1RFZeughW6" target="_blank" style={{color: "white", textDecoration: "none"}}>
                ...
                <div className="bottom">
                    <hr />
                    <p className="text-end mb-0 Poppins">© 2025 PT Abdi Media Kreatif &middot; All Rights Reserved</p>
                </div>
            </div>
        </footer>
    );
